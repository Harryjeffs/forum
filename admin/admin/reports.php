...
$action = $loggedInUser->username.'visited the admin reports page';
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                We'll be right back.
                <small>We're just fixing a few things.</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <div class="alert alert-warning">
                        This page is currently being developed or fixed. Please check back later.
                    </div>
                </div>
                <!-- /.box-body -->
            </div>
