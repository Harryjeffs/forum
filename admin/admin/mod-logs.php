...
$sqlStr = "SELECT * FROM `forum_user_logs` WHERE level = 6 ORDER BY TIMESTAMP desc";
$sqlStrAux = $mysqli->query("SELECT * FROM `forum_user_logs` WHERE level = 6 ORDER BY TIMESTAMP desc");
...
$p->limit($items);
$p->target("/forum/admin/admin/mod-logs.php");//#page/1/
$p->changeClass("pagination pull-right");
$p->urlFriendly(false);
$p->currentPage($page);
$p->calculate();

$action = $loggedInUser->username.' visited the moderator log page.';
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <?php
                            if($query->num_rows == 0){
                                echo "<tr><td colspan='5'>Our mods haven't done anything.</td></tr>";
                            }else{
