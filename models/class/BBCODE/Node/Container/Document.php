...
class Node_Container_Document extends Node_Container
{
	...
	public static function default_bbcodes()
	{
		return array(
			...
			new BBCode('p', '<p>%content%</p>'),
			new BBCode('footer', '<footer>%content%</footer>'),
			new BBCode('blockquote', '<blockquote>%content%</blockquote>'),
			...
			new BBCode('center', '<center>%content%</center>', BBCode::BLOCK_TAG),
			...
			new BBCode('icq', '<a href="http://www.icq.com/people/about_me.php?uin=%content%">
				<img class=\'img-responsive\' src="http://status.icq.com/online.gif?icq=%content%&amp;img=5"> %content%</a>',
			...
			new BBCode('skype', '<a href="skype:jovisa737590?call">
				<img class=\'img-responsive\' src="http://mystatus.skype.com/bigclassic/%content%" style="border: none;" width="182"
			...
			new BBCode('wikipedia', '<a href="http://www.wikipedia.org/wiki/%content%">%content%</a>',
				BBCode::INLINE_TAG, false, array(), array('text_node'), BBCode::AUTO_DETECT_EXCLUDE_ALL),
			new BBCode('video', function($content, $attribs)
			{
			...
			new BBCode('paypal', function($content, $attribs)
				...
				<img class=\'img-responsive\' src="https://www.paypal.com/en_US/i/btn/x-click-but21.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"/></a>';
				},
				BBCode::INLINE_TAG, false, array(), array('text_node'), BBCode::AUTO_DETECT_EXCLUDE_ALL),
            ...
            new BBCode('spoiler', function($content, $attribs)
            {
                return '<div class="spoiler" style="margin:5px 15px 15px 15px; max-width: 100%;">
				<div style="margin:0 0 2px 0; font-weight:bold;">Spoiler: '.$attribs["title"].'
			...
			new BBCode('img', function($content, $attribs, $node)
			{
				...
				return "<img{$attrs}  class='img-responsive' src=\"{$content}\" />";
			}, BBCode::INLINE_TAG, false, array(), array('text_node'), BBCode::AUTO_DETECT_EXCLUDE_ALL),
			...
			new BBCode('url', function($content, $attribs, $node)
			{
				...
				return "<a href=\"{$attribs['default']}\" target='_blank'>{$content}</a>";
			}, BBCode::INLINE_TAG, false, array(), array('text_node'), BBCode::AUTO_DETECT_EXCLUDE_ALL)
		);
	}
